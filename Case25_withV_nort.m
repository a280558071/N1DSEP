...
Cons_Load=[];
for C_l=1:L
    Cons_Load=[Cons_Load,Full_I*f(:,C_l)==[-(Load);g_Sub(:,C_l)]];%-rt(:,C_l)
...
load('Case25nort_Gurobi_BB_V_nox0_withDE3_Gap5.mat','s_x1','s_y1','s_be1');
assign(x,s_x1);
assign(y,s_y1);
assign(be,s_be1);
...
s_Obj1=value(Obj);
save('Case25nort_Gurobi_BB_V_withx0_withDE2_Gap5');
